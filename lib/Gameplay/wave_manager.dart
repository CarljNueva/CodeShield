...
void _startNewWave() {
    ...
    if (currentWaveNumber % 5 == 0) {
      ...
      List<OSILayer> layers = [
        OSILayer.layer6,OSILayer.layer7, OSILayer.layer3, OSILayer.layer4, OSILayer.layer5, 
      ]; 
    ...
    switch(currentLayer) {
      ...
      case OSILayer.boss: layerName = " !!! MULTI-LAYER ATTACK: BOSS!!!"; break;
      default: layerName = "Unknown Layer";
    }
  ...
  Future<void> _spawnEnemy() async {
    ...
    if (currentLayer == OSILayer.boss && !bossSpawned) {
      ...
      List<EnemyType> allTypes = EnemyType.values.where((t) => t != EnemyType.trojan).toList();
