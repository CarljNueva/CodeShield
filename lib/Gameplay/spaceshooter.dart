...
class SpaceShooterGame extends FlameGame
  ...
  Future<void>? onLoad() async {
    ...
    position: Vector2(canvasSize.x - 320, canvasSize.y - 180), // Next to the other button
    ...
    add(
      SpriteButtonComponent(
        ...
        onPressed: () {
           ...
           add(ScanWave(position: Vector2(player.position.x - 20, 0))..paint.color = Colors.cyan.withValues(alpha: 0.3));
        },
      ),);
...
void applyPowerUp(PowerUpType type) {
  switch (type) {
    ...
    case PowerUpType.totalReset:
      ...
      add(Explosion(position: size / 2)..scale = Vector2.all(10)); // Massive flash
      break;
