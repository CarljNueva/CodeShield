...
class _EnemyCarouselState extends State<EnemyCarousel> {
  ...
  final List<CarouselItemData> carouselData = [
    CarouselItemData(
      ...
      fullDetails: "Aaoisdujfnasjikdnfkljasbdngujbdfg",
    ),
    CarouselItemData(
      color: Colors.teal,
      title: "The Forest",
      details: "Lush, green, and teeming with wildlife.",
      fullDetails: "OIujnfjnadklfngkladfngkljdnfgnsd",
    ),
    CarouselItemData(
      color: Colors.indigo,
      title: "The Night Sky",
      details: "Endless stars painting a canvas of infinity.",
      fullDetails: "OIunidjfnglkjsdnfglkusndfiuhnfgilkhjn",
    ),
    CarouselItemData(
      color: Colors.deepOrange,
      title: "The Canyon",
      details: "Carved by time, standing tall and majestic.",
      fullDetails: "inidfujngsiujnfgklhjnsfklgjhnfgh",
    ),
    CarouselItemData(
      color: Colors.brown,
      title: "The Mountains",
      details: "Snow-capped peaks reaching for the clouds.",
      fullDetails: "inadifjngkljadsnfgkljsnfghiosfnjiunt",
    ),
  ];
